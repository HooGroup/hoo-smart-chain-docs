...
## 虎符智能链Hsc简介
虎符智能链 Hoo Smart Chain (Hsc) 是一个去中心化高效节能公链，也是虎符开放平台推出的首个产品，在支撑高性能交易的基础上，实现智能合约的兼容。虎符智能链Hsc的原生数字资产为HT，采用HPoS共识机制。
...
- 为降低大用户在Hsc Dapp上的参与成本，Hsc元交易功能将对持有HT的用户的Gas fee阶梯式减免
### 流量扶持规划
...
- 认准官方网址（hscchain.com），避免出现私钥被钓鱼等情况。
